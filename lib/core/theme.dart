...
class ThemeConfig {
  ...
  static ThemeData get lightTheme => createTheme(
    brightness: Brightness.light,
    background: GlobalColors.maniBackgroundColor,
    cardBackground: GlobalColors.maniBackgroundColor,
    primaryText: GlobalColors.black,
    secondaryText: GlobalColors.black,
    accentColor: GlobalColors.accentColor,
    divider: GlobalColors.lightGray,
    buttonBackground: GlobalColors.secondPrimaryColor,
    buttonText: GlobalColors.white,
    disabled: GlobalColors.white,
    error: GlobalColors.errorColor,
  );
